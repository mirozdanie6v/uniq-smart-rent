-- Stage 5: payment checkout events and indexes on the existing finance schema.
-- Checkout metadata stays in payments.provider_payload_json so this migration
-- remains additive and safe for the already-migrated D1 database.
